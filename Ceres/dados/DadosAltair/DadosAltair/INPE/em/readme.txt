...
implu_site.dat >  resposta instrumental. (metade do tempo de exposicao e resposta do ccd)
t_ratio_site.dat > tempo TU em segundos e razao de fluxo


implu_site.dat >  resposta instrumental. (metade do tempo de exposicao e resposta do ccd)
Cada linha do arquivo corresponde ao instante em relacao ao instante da imagem (este normalmente é o centro da
exposicao) e a resposta do ccd. Se fosse um fotometro a resposta seria diferencial. Esta resposta é igual para todo o
ccd, entao deve ser igual em todas as linhas e sera normalizada internamente.
