...
\indent \indent Em 21 de Maio de 2008 houve uma ocultação por Tritão cuja sombra cruzou o sul da África. Dos sítios que observaram, apenas duas cordas foram positivas. As observações foram feitas de La Réunion e da Namíbia com câmeras rápidas. Dentre elas, uma observou somente a atmosfera do objeto. Foi a segunda ocultação de Tritão, sendo a primeira observada em Julho de 1997 \citep{Elliot2000}.

Os perfis de pressão da atmosfera de Tritão foram calculadas, porém, devido a uma das cordas ter pego somente atmosfera, não foi possível determinar a posição das cordas em relação ao corpo com precisão. Isso resultou em valores com barras de erro muito grandes comparadas às encontradas na literatura.

\cite{Hansen1992} obteve que a pressão atmosférica de Tritão em sua superfície estaria em ascensão. Neste trabalho, a pressão atmosférica foi obtida com um valor muito diferente do valor esperado mesmo ao nível de $3\sigma$. O resultado obtido também é inconsistente com outros valores da literatura que confirmam o esperado por \cite{Hansen1992}.
