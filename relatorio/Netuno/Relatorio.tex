...
\caption{Offsets before and after CR correction for the night of August 20, 1993 observed with the Perkin-Elmer telescope.}
...
\item If there is another night with $\Delta B$ calculated observed with the same filter in the same telescope within at most 3 days apart, the $\Delta B$ from this night was used in the CR correction.
\item If there is no close night with $\Delta B$ calculated, it was used the mean $\Delta B$ calculated for nights observed with the same filter and same telescope for the correction of CR.
\item Other situations, no CR correction was made.
\end{itemize}
