...
output = ['NSDS/NSDS_Ananke_OHP.txt',
'NSDS/NSDS_Carme_OHP.txt',
'NSDS/NSDS_Elara_OHP.txt',
'NSDS/NSDS_Himalia_OHP.txt',
'NSDS/NSDS_Leda_OHP.txt',
'NSDS/NSDS_Lysithea_OHP.txt',
'NSDS/NSDS_Pasiphae_OHP.txt',
'NSDS/NSDS_Phoebe_OHP.txt',
'NSDS/NSDS_Siarnaq_OHP.txt',
'NSDS/NSDS_Sinope_OHP.txt',
'NSDS/NSDS_Albiorix_ESO.txt',
'NSDS/NSDS_Ananke_160.txt',
'NSDS/NSDS_Ananke_ESO.txt',
'NSDS/NSDS_Callirrhoe_160.txt',
'NSDS/NSDS_Callirrhoe_ESO.txt',
'NSDS/NSDS_Carme_160.txt',
'NSDS/NSDS_Carme_ESO.txt',
'NSDS/NSDS_Carme_IAG.txt',
'NSDS/NSDS_Elara_160.txt',
'NSDS/NSDS_Elara_ESO.txt',
'NSDS/NSDS_Elara_IAG.txt',
'NSDS/NSDS_Elara_ZEI.txt',
'NSDS/NSDS_Himalia_160.txt',
'NSDS/NSDS_Himalia_ESO.txt',
'NSDS/NSDS_Himalia_IAG.txt',
'NSDS/NSDS_Himalia_ZEI.txt',
'NSDS/NSDS_Leda_160.txt',
'NSDS/NSDS_Leda_ESO.txt',
'NSDS/NSDS_Lysithea_160.txt',
'NSDS/NSDS_Lysithea_ESO.txt',
'NSDS/NSDS_Lysithea_IAG.txt',
'NSDS/NSDS_Megaclite_ESO.txt',
'NSDS/NSDS_Nereid_160.txt',
'NSDS/NSDS_Nereid_ESO.txt',
'NSDS/NSDS_Nereid_IAG.txt',
'NSDS/NSDS_Paaliaq_ESO.txt',
'NSDS/NSDS_Pasiphae_160.txt',
'NSDS/NSDS_Pasiphae_ESO.txt',
'NSDS/NSDS_Pasiphae_IAG.txt',
'NSDS/NSDS_Pasiphae_ZEI.txt',
'NSDS/NSDS_Phoebe_160.txt',
'NSDS/NSDS_Phoebe_ESO.txt',
'NSDS/NSDS_Phoebe_IAG.txt',
'NSDS/NSDS_Phoebe_ZEI.txt',
'NSDS/NSDS_Praxidike_ESO.txt',
'NSDS/NSDS_Siarnaq_ESO.txt',
'NSDS/NSDS_Sinope_160.txt',
'NSDS/NSDS_Sinope_ESO.txt',
'NSDS/NSDS_Sinope_IAG.txt',
'NSDS/NSDS_Sycorax_ESO.txt',
'NSDS/NSDS_Themisto_ESO.txt']
