...
output = ['CDS/CDS_Ananke_OHP.txt',
'CDS/CDS_Carme_OHP.txt',
'CDS/CDS_Elara_OHP.txt',
'CDS/CDS_Himalia_OHP.txt',
'CDS/CDS_Leda_OHP.txt',
'CDS/CDS_Lysithea_OHP.txt',
'CDS/CDS_Pasiphae_OHP.txt',
'CDS/CDS_Phoebe_OHP.txt',
'CDS/CDS_Siarnaq_OHP.txt',
'CDS/CDS_Sinope_OHP.txt',
'CDS/CDS_Albiorix_ESO.txt',
'CDS/CDS_Ananke_160.txt',
'CDS/CDS_Ananke_ESO.txt',
'CDS/CDS_Callirrhoe_160.txt',
'CDS/CDS_Callirrhoe_ESO.txt',
'CDS/CDS_Carme_160.txt',
'CDS/CDS_Carme_ESO.txt',
'CDS/CDS_Carme_IAG.txt',
'CDS/CDS_Elara_160.txt',
'CDS/CDS_Elara_ESO.txt',
'CDS/CDS_Elara_IAG.txt',
'CDS/CDS_Elara_ZEI.txt',
'CDS/CDS_Himalia_160.txt',
'CDS/CDS_Himalia_ESO.txt',
'CDS/CDS_Himalia_IAG.txt',
'CDS/CDS_Himalia_ZEI.txt',
'CDS/CDS_Leda_160.txt',
'CDS/CDS_Leda_ESO.txt',
'CDS/CDS_Lysithea_160.txt',
'CDS/CDS_Lysithea_ESO.txt',
'CDS/CDS_Lysithea_IAG.txt',
'CDS/CDS_Megaclite_ESO.txt',
'CDS/CDS_Nereid_160.txt',
'CDS/CDS_Nereid_ESO.txt',
'CDS/CDS_Nereid_IAG.txt',
'CDS/CDS_Paaliaq_ESO.txt',
'CDS/CDS_Pasiphae_160.txt',
'CDS/CDS_Pasiphae_ESO.txt',
'CDS/CDS_Pasiphae_IAG.txt',
'CDS/CDS_Pasiphae_ZEI.txt',
'CDS/CDS_Phoebe_160.txt',
'CDS/CDS_Phoebe_ESO.txt',
'CDS/CDS_Phoebe_IAG.txt',
'CDS/CDS_Phoebe_ZEI.txt',
'CDS/CDS_Praxidike_ESO.txt',
'CDS/CDS_Siarnaq_ESO.txt',
'CDS/CDS_Sinope_160.txt',
'CDS/CDS_Sinope_ESO.txt',
'CDS/CDS_Sinope_IAG.txt',
'CDS/CDS_Sycorax_ESO.txt',
'CDS/CDS_Themisto_ESO.txt']
...
for idy, value in enumerate(arquivo):
    ...
    for i in dados:
        ...
        g.write(' {} {} {:4.0f} {:4.0f} {:16.8f} {:4.1f} {:2s} {:2s} {:3d}\n'\
.format(ra[0], dec[0], raerr[0], deerr[0], epoch.jd, mag, filt, code[idy], iau_code[idy]))
