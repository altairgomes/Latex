...
\begin{figure*}
\begin{centering}
\subfigure[NEP081 JPL and \cite{Emelyanov2015} ephemeris]{\includegraphics[width=8.8cm]{figures/JPL-EME_Triton.eps} \label{Fig:offxtanomxjpl}}
\subfigure[\cite{Zhang2013} and \cite{Emelyanov2015} ephemeris]{\includegraphics[width=8.8cm]{figures/Zhang-EME.eps} \label{Fig:offxtanomxni}}
\caption{Comparison between the ephemeris between the \cite{Emelyanov2015}, \cite{Zhang2013} and JPL ephemeris.}
\label{Fig:offxanom}
\end{centering}
\end{figure*}
