...
\usepackage[breaklinks=true, draft]{hyperref} %% to avoid \citeads line fills
\usepackage{arydshln}
...
\title{Stellar occultation predictions for  11 irregular satellites of giant planets up to 2017
...
{We identified candidates to stellar occultations by the irregular satellites from the UCAC4 catalogue and from a catalogue of stars in the sky-path of Neptune obtained from observations made with the ESO2p2/WFI (2.2 m Max-Planck ESO telescope with the Wide Field Imager) instrument. These catalogues were crossed with the ephemeris of the satellites to identify stellar occultations. We used a new ephemeris based solely on the observations from \cite{GomesJunior2015} to generate predictions for the short-time future for the satellites of Jupiter and Phoebe. For Nereid and Triton we used ephemeris from the literature.}
{We managed to identify 396 candidates of stellar occultations between the period of January, 2016 and December, 2017. We made observational tests for the prediction of the event of Himalia in March 03, 2015. The stars and objects were observed close to the date predicted and in the same field to minimize errors and the obtained relative satellite-star positions were used to evaluate the predictions. We call attention for an occultation by Triton on a bright star in October 5, 2017. The event can be observed from Europe and the east coast of USA and will be a good opportunity to study the atmosphere of the satellite.}
...
In order to have efficient ephemerides for predicting the stellar occultations by irregular satellites, we need predictions based on recent observations.  This is why we decided to develop our own
...
In Fig. \ref{Fig: JPL-STE} it is presented the offsets of the positions published by \cite{GomesJunior2015} for the satellite Carme in declination relative to our ephemeris, to \cite{Jacobson2012} JUP300 JPL ephemeris and \cite{Emelyanov2008} ephemeris. It is possible to see that the systematic error point out by \cite{GomesJunior2015} is reduced with our ephemeris, as expected.

\begin{figure}
\includegraphics[width=8.8cm]{figures/Carme_ephemeris.eps} 
\caption{Offsets in declination of the positions published by \cite{GomesJunior2015} for Carme. The red "x" relative to the special-tailored ephemeris, the blue "+" relative to the JUP300 JPL ephemeris and the green dot relative to \cite{Emelyanov2008}. As expected, it is possible to see that the systematic error point out by \cite{GomesJunior2015} is reduced with the STE ephemeris.  \label{Fig: JPL-STE}}
\end{figure}
...
\begin{figure}
\begin{centering}
\subfigure[SAT375 JPL and PH15]{\includegraphics[width=8.8cm]{figures/Phoebe_JPL-ph15.eps} \label{Fig:eph-Triton-eme}}
\subfigure[\cite{Emelyanov2007} and PH15]{\includegraphics[width=8.8cm]{figures/Phoebe_EME-ph15.eps} \label{Fig:eph-Triton-zhang}}
...
A total of 396 events were identified between January 2016 and December 2017. In table \ref{Tab: satellite-occultation} we present the number of stellar occultations predicted by year for each satellite. Table \ref{Tab: occ-list} shows a sample of the catalogue of occultations generated and their parameters, which are necessary to produce occultation maps. Since these objects are very small, the duration of each event is a few seconds. All the occultation tables and maps will be publicly available at the CDS. No star brighter than MagR*=18 was identified to be occulted by Triton in 2016. Since the flux drop during such an occultation is very small, we don't publish this events. In Fig. \ref{Fig: ocultacao} we show an example of an occultation map. In this case is an occultation by Triton that is predicted to happen in October 05, 2017. This event can be observed from Europe and the east coast of USA and will be a great opportunity to study the atmosphere of the satellite.
