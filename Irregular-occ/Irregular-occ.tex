...
As explicited in section \ref{Sec: introducao}, there is no consensus on a single model about the region where the irregular satellites were formed. \cite{Cuk2004} showed that the progenitor of the Himalia group may have origin in heliocentric orbits similar to the Hilda asteroid group.

Phoebe, the most studied irregular satellite, was identified by \cite{Clark2005} that its surface is probably covered by material of cometary origin. It was also stated by \cite{Johnson2005} that if the porosity of Phoebe would be of about 15\%, Phoebe would have an uncompressed density similar to those of Pluto and Triton.
...
\begin{figure*}
\begin{centering}
\subfigure[Offset from the JPL ephemeris]{\includegraphics[scale=0.25]{figures/DEC_anom.png} \label{Fig:offxtanomxjpl}}
\subfigure[\textcolor{red}{Offset from the numerical integration}]{\includegraphics[scale=0.25]{figures/DEC_anom.png} \label{Fig:offxtanomxni}}
\caption{Offsets of the declination of Carme by true anomaly from the JPL ephemeris and \textcolor{red}{from the numerical integration from the positions obtained in \cite{GomesJunior2015}}.}
\end{centering}
\end{figure*}
...
\begin{table}
\caption{\label{Tab: comparison-Himalia} Comparison between the predictions of the Himalia occultation at March 03, 2015. \textcolor{red}{Tem que ver direito o offset do ajuste}}
\begin{centering}
\begin{tabular}{lcc}
\hline  \hline
...
\begin{table}
\caption{\label{Tab: comparison-Elara} Comparison between the predictions of Elara occultation at March 30, 2015. \textcolor{red}{Tem que ver direito o offset do ajuste}}
\begin{centering}
\begin{tabular}{lcc}
\hline  \hline
\multicolumn{3}{c}{Difference from nominal prediction} \tabularnewline
...
\end{tabular}
\par \end{centering}
Occultations predicted using the UCAC4 catalogue. For Nereid and Triton, the occultations in 2015 and 2016 were predicted using the WFI catalogue as explained in Sec. \ref{Sec: predictions}.
\end{table}
