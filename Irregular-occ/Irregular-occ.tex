...
\hline
Ananke & 29 &  & 1 \tabularnewline
Carme & 46 &  & 1 \tabularnewline
Elara & 86 &  & 1 \tabularnewline
Himalia & $(150 \pm 20) \times (120\pm 20)$ &  & 2 \tabularnewline
Lysithea & 36 &  & 1 \tabularnewline
Pasiphae & 62 & & 1 \tabularnewline
Sinope & 37 & & 1 \tabularnewline
\hdashline
Phoebe & $212 \pm 1.4$ & & 3 \tabularnewline
\hdashline
Nereid & $340 \pm 50$ &  & 4 \tabularnewline
Triton & $2707 \pm 2.0$ &  & 5 \tabularnewline
\hline
\end{tabular}
\tablebib{
(1) \cite{Rettig2001}; (2) \cite{Porco2003}; (3) \cite{Thomas2010}; (4) \cite{Thomas1991} (5) \cite{Thomas2000}.}
\end{centering}
\tablefoottext{a}{Using a mean distance from Jupiter of XX AU, from Saturn of XX AU and from Neptune of XX AU.}
\par
\end{table}
...
\begin{table}
\caption{\label{Tab: comparison-Elara} Comparison between the predictions of Elara occultation at March 30, 2015. \textcolor{red}{Ainda vou terminar de preencher a tabela e tem que ver direito o offset do ajuste}}
\begin{centering}
\begin{tabular}{lcc}
\hline  \hline
\multicolumn{3}{c}{Difference from nominal prediction} \tabularnewline
...
The candidate stars was searched in the UCAC4 catalogue, except for the candidates in 2015 and 2016 for Triton and Nereid. In this case, we used the WFI catalogue that was generated from observations made with ESO2p2/WFI CCD mosaic that covered the path of Neptune in the sky-plane up to 2016.

In table \ref{Tab: satellite-occultation} it's presented the number of stellar occultations predicted by year for each satellite.
...
\hline
Ananke &  &  & & \tabularnewline
Carme &  &  &  & \tabularnewline
Elara &  &  &  & \tabularnewline
Himalia &  &  &  & \tabularnewline
Lysithea &  &  &  & \tabularnewline
Pasiphae &  & &  & \tabularnewline
Sinope &  &  &  & \tabularnewline
\hdashline
Phoebe & 13 & 22 & 98 & 133\tabularnewline
\hdashline
Nereid & 40 & 11 & 1 & 52 \tabularnewline
