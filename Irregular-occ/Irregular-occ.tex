...
In the intent to obtain their physical parameters (size, shape, albedo, density, etc) and help identify their origin locations, we will make use of the stellar occultation technique. This technique is the best one to obtain the physical parameters of the solar system objects from ground-based observations providing more accurate results than other techniques \citep{Sicardy2011, Ortiz2012, Braga-Ribas2014}.
