...
\usepackage{times}  %%% neede to embed font 1 text
...
\item $\vec{r_i}$ the position of the $i$ body with respect \textbf{to the center of Jupiter}
...
\item $\Phi_i$ is the latitude of the $i$ satellite with respect to Jupiter's equator.
\end{itemize}
