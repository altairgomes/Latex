...
\begin{figure*}
\subfigure{\includegraphics[width=8.8cm]{Laurene/residuals/Himalia_resid.eps}   \label{Fig: residuals-Himalia}}
\subfigure{\includegraphics[width=8.8cm]{Laurene/residuals/Carme_resid.eps}  \label{Fig: residuals-Carme}}
...
\caption{Occultation map for Himalia regarding to the fifth event sampled in Table \ref{Tab: occ-list}}
\label{Fig: ocultacao}
\end{centering}
\end{figure*}
