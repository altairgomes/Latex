...
\usepackage{epstopdf}
\usepackage{color}
\usepackage[breaklinks=true]{hyperref}  % draft because there is an error = 'pdfTeX error (ext4): \pdfendlink ended up in different nesting level than \pdfstartlink'.
