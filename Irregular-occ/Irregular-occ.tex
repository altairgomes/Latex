...
\cite{GomesJunior2015} published 6523 new positions for 18 irregular satellites from observations made between 1992 and 2014 with an estimated error of about 60 to 80 mas. Based on this set of original positons, we performed numerical integrations for deriving new orbits for the eight largest irregular satellites of Jupiter: Himalia, Elara, Pasiphae, Carme, Lysithea, Sinope, Ananke and Leda. This corrected systematic errors and resulted in an ephemeris more accurate/precise than JPL JUP300 for these bodies at least in the immediate future. For Phoebe we updated the ephemeris from \cite{Desmars2013} using 75\% more positions than the previous one. Due to their orbital configurations, it is common belief that the irregular satellites were captured by the giant planets in the early Solar System, but there is no consensus for a single model explaining where they were formed. Size, shape, albedo and composition would help a lot to trace back their true origin, but these physical parameters are yet poorly known for irregular satellites. The observation of stellar occultations would allow for the determination of such parameters. Indeed Jupiter will cross the galactic plane in 2019-2020 and Saturn in 2018, improving a lot the chances of observing such events in the near future. Using the derived ephemerides and the UCAC4 catalogue we managed to identify \noccs candidate stellar occultations between January 2016 and December 2020 for the 9 irregular satellites studied here. We discussed how the successful observation of a stellar occultation by these objects is quite possible and present some of those potential occultations.
\end{abstract}
...
We present in this paper new numerical integration of the orbits of the 8 major irregular satellites of Jupiter (Himalia, Elara, Pasiphae, Lysithea, Carme, Ananke, Sinope and Leda) using only the positions obtained by \citetalias{GomesJunior2015}. We aim to eliminate the systematic errors in the JPL ephemeris (see Sec. \ref{Sec: integration}). %For an object at the distance of Jupiter, this represents an error langer than 700 km in the shadow path of an occultation.
...
In Table \ref{Tab:STE-error} it is presented the mean offsets of the \citetalias{GomesJunior2015} positions relative to the same 3 ephemeris as above. We can see that the mean offsets are highly reduced with the STE ephemeris.

\begin{table}
\caption{\label{Tab:STE-error} Mean offsets of the \protect\citetalias{GomesJunior2015} positions relative to the STE, \protect\cite{Jacobson2012} and \protect\cite{Emelyanov2008} ephemeris .}
\begin{centering}
...
\hline
Ananke & $-10$ & $3$ & $60$ & $-108$ & $101$ & $-107$ \tabularnewline
Carme & $14$ & $-1$ & $-3$ & $-80$ & $-6$ & $-45$ \tabularnewline
Elara & $3$ & $-12$ & $20$ & $-50$ & $23$ & $-83$ \tabularnewline
Himalia & $-15$ & $-7$  & $-19$  & $-11$ & $-18$  & $-13$ \tabularnewline
Leda & $-9$ & $-8$ & $60$ & $-13$ & $166$ & $92$ \tabularnewline
Lysithea & $15$ & $-21$ & $40$ & $-43$ & $117$ & $-76$ \tabularnewline
Pasiphae & $4$ & $-16$ & $-17$ & $-82$ & $-10$ & $-54$ \tabularnewline
Sinope & $9$ & $-4$ & $10$ & $-35$ & $11$ & $-52$ \tabularnewline
\hline
\end{tabular}
\par \end{centering}
\end{table}
...
We computed the precision of the PH15 ephemeris considering three sets of observations: all the positions available; only the positions of \citetalias{GomesJunior2015}; and all the positions without \citetalias{GomesJunior2015}. In Fig. \ref{Fig:err-Phoebe} is shown the comparison between them for the time spam 2016-2021. It is possible to see that even considering only the positions of \citetalias{GomesJunior2015}, the estimated error of the ephemeris is smaller than 12 mas. The computed precision does not take into account the precision in the position of Saturn.

\begin{figure}
\begin{centering}
\includegraphics[width=8.8cm]{figures/PH15_err_angsep.eps}  
\caption{Comparison of the precision of the PH15 ephemeris where three different sets of positions were used to compute the ephemeris: all observations; only positions of \citetalias{GomesJunior2015}; and all the positions without \citetalias{GomesJunior2015}.}
...
The first preliminary catalogue version of the ESA astrometry satellite GAIA \citep{deBruijne2012} is expected to be released up to the end of 2016 (The catalogue with five-parameter astrometric solutions is up to the end of 2017). The precise star positions to be derived by GAIA will provide better predictions with the main source of error being the ephemeris. Astrometric reduction of observations published in \citetalias{GomesJunior2015} will be revised with the GAIA catalogue and the predictions will be improved. Since we cannot foresee exactly when the GAIA catalogue will be released and when new and re-reduced satellite positions in the GAIA frame will become available, we decided to publish predictions up to the end of 2020. In the GAIA era, the occultations predicted will be updated.
