...
\begin{document}
\newcommand{\noccs}{396 } % total number of occultations
...
\subfigure[\protect\cite{Zhang2014} and \protect\cite{Emelyanov2015}]{\includegraphics[width=8.7cm]{figures/Zhang-EME.eps} \label{Fig:eph-Triton-zhang}}
